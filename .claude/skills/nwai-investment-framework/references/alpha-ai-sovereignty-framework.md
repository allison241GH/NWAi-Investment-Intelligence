...
> **STATUS: DRAFT — NOT INSTALLED.** No pipeline file references this document yet. It becomes
> operational only at the Phase 2 install (see "Pipeline Hooks — Phase 2 Install Spec" below),
> after the spawning thesis is signed off. Until then, commands and agents should not apply it.
...
## Pipeline Hooks — Phase 2 Install Spec (DESIGN ONLY — nothing below is active)

*This section is the full downstream design, to be installed as a plugin minor version after thesis
sign-off. Until installed, no command or agent applies this framework.*
