> **⚠️ ARCHIVED — Superseded by triage-with-scoring.**
>
> This 6-gate AutoKill framework was NWAi's original screening framework. It has been replaced by the **NWAi Universal Triage Framework** (3 hard gates + 6-dimension Opportunity scoring + 5-dimension Readiness scoring). See `../gates-and-flags.md`.
>
> This file is retained for historical context only. Do not use for active screening.
