...
*v0.32.0 | June 9, 2026 | New World Angels Investment Intelligence*
...
| `gates-and-flags-techgroup.md` | **TechGroup extension** to the universal framework (v2.1): Track Determination (A/B), Track A Software/AI/Cloud 6-dimension Opportunity rubric, Track B Hardware/Robotics 6-dimension Opportunity rubric, AI Wrapper Assessment, Replicability Speed Flag, **Agent-Era Exposure Signal** (lightweight triage trip-wire for the Agent-Era Readiness Framework), Hardware Last Mile Standard, TRL Hard Cap, TechGroup Live Pitch Questions; cross-references universal gates-and-flags.md | Screen (TechGroup) |
...
| `scout-questions.md` | Phase 1 viability (Q1 + Q1b Demand Signal Test + Q2 + Q3, scored 0–5 with Triage delta) + 4 strategic dimensions (Q4 Ecosystem Role, Q5 Adjacent Displacement Risk, Q6 Macro Tailwind, **Q7 Agent-Era Readiness**) + Phase 2 execution (scored 0–5) + Scout Conviction Score (/19, unchanged — Q7 added within the 20% strategic weight) + 2-page output format | Scout |
